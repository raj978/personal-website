            ...
            <section className="bg-gray-100 max-w-[42rem] border border-black/5 rounded-lg overflow-hidden sm:pr-8 relative sm:h-[22rem] hover:bg-gray-200 transition sm:group-even:pl-8 dark:text-white dark:bg-white/10 dark:hover:bg-white/20">
                <div
                    ...
                    <div className="flex gap-4 mt-4">
                        {githubUrl && (
                            <LinkPreview url={githubUrl} aria-label="GitHub">
                                <FaGithub
                                    className="text-gray-700 dark:text-white/70 hover:text-black dark:hover:text-white text-xl transition"/>
                            </LinkPreview>
                        )}
                        {liveSiteUrl && (
                            <LinkPreview url={liveSiteUrl} aria-label="Live Site">
                                <FaExternalLinkAlt
                                    className="text-gray-700 dark:text-white/70 hover:text-black dark:hover:text-white text-xl transition"/>
                            </LinkPreview>
                        )}

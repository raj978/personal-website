...
import { MotionValue, motion, useScroll, useTransform, useAnimation } from "framer-motion";
...
export const MacbookScroll = ({
    ...
    const targetScaleY = height / (22 * 16); // Assuming the initial height is 22rem
    ...
    return (
        <div className="relative [perspective:800px]">
            <div
                ...
                className="h-[12rem] w-[32rem] bg-transparent rounded-2xl p-2 relative"
            >
                <div
                    style={{

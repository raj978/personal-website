...
const CustomHero = () => {
    ...
    return (
        <motion.section
            ref={ref}
            id="home"
            className="h-full scroll-mt-[20rem]">
            <div className="container mx-auto h-full">
                <div className="flex items-center justify-center flex-row pb-24">
                    {/*Text*/}
                    <div ref={containerRef} className="text-left mr-8 order-none">
                        ...
                        <div className="flex flex-row items-center gap-8">
                            <LinkPreview url={resumeUrl}>
                                <button
                                    className="relative inline-flex h-12 overflow-hidden rounded-full p-[3px] focus:outline-none focus:ring-2 focus:ring-slate-400 focus:ring-offset-5 focus:ring-offset-slate-50 mb-8">
                    ...
                    {/*Photo*/}
                    <div className="order-none mb-0"><Photo /></div>
                </div>
            </div>
        </motion.section>
    );

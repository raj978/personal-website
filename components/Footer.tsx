...
export default function Footer() {
    return (
        <footer className="mb-10 px-4 text-center text-gray-500">
            ...
            <p className="text-xs">The source code for this website can be found on <Link href="https://github.com/raj978/personal-website" className="underline" target="_blank">GitHub</Link>. | Last Updated on : September 2024</p>
        </footer>
    );
}

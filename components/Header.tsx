                ...
                <ul className="flex w-[22rem] flex-wrap items-center justify-center gap-y-1 text-[0.9rem] font-medium text-gray-500 sm:w-[initial] sm:flex-nowrap sm:gap-5">
                    {links.map((link) => (
                        ...
                        >
                            <Link
                                className={clsx(
                                    "flex w-full items-center justify-center px-3 py-3 hover:text-green-500 transition dark:text-white-500 dark:hover:text-green-500",
                                    {
                            ...
                            >
                                ...
                                {link.name === activeSection && (
                                    <motion.span
                                        className="bg-green-100 rounded-full absolute inset-0 -z-10 dark:bg-green-900"
